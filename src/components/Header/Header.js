      ...
      {me && (
        <div className="header__actions-authorized">
          ...
          <div className="header__actions-authorized-mobile">
            <input
              type="checkbox"
              id="header__actions-authorized-drawer-toggle"
              className="header__actions-authorized-drawer-toggle"
            ></input>
            <label
              htmlFor="header__actions-authorized-drawer-toggle"
              className="header__actions-authorized-drawer-toggle-view"
            ></label>
            <label
              htmlFor="header__actions-authorized-drawer-toggle"
              className="header__actions-authorized-drawer-toggle-background"
            ></label>
            <div className="header__actions-authorized-drawer">
              <div className="header__actions-authorized-menu-mobile">
                <label
                  htmlFor="header__actions-authorized-drawer-toggle"
                  className="header__actions-authorized-drawer-toggle-close-btn"
                ></label>
                ...
                <div className="header__actions-authorized-menu-mobile-footer">
                  <Link
                    to="/profile"
                    className="header__actions-authorized-profile"
                  >
                    Аккаунт
                  </Link>
                </div>
