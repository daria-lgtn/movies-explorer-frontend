  ...
  return (
    <section className="about-project" id="about">
      ...
      <div className="about-project__progress">
        ...
        <p className="about-project__progress-bar">4 недели</p>
        <p className="about-project__progress-label">Back-end</p>
        <p className="about-project__progress-label">Front-end</p>
      </div>
    </section>
  );
}
